...
Label_0=Label(root, text="Login Here", width=20, fg="brown", font=("bold",20))
...
compose=Label(root, text="Send your message", fg="brown", width=20, font=("bold",15))
compose.place(x=200,y=210)
